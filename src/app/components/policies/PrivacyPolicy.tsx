  ...
  return (
    <div className="py-20 px-6 max-w-4xl mx-auto text-foreground">
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <li><strong>Finansal Bilgiler:</strong> Ödeme işlemleri sırasında kullanılan kart bilgileri; Lemon Squeezy ödeme altyapısı aracılığıyla abonelik ücretlerinin tahsil edilmesi amacıyla (Kart bilgileri tarafımızca saklanmaz),</li>
